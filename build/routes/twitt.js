...
router.get('/one/:twittId', twitt_1.default.oneTwitt);
router.get('/by-user/:userId', twitt_1.default.twittsByUser);
router.post('/create', auth_1.verifyToken, auth_1.verifyUserOrAdmin, twitt_1.default.createTwitt);
router.put('/add-fav/:twittId', auth_1.verifyToken, twitt_1.default.favOneTwitt);
router.put('/undo-fav/:twittId', auth_1.verifyToken, twitt_1.default.favOneTwitt);
