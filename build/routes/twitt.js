...
router.get('/favourite', twitt_1.default.favOneTwitt);
router.get('/:twittId', twitt_1.default.oneTwitt);
router.post('/:userId/create', auth_1.verifyToken, auth_1.verifyUserOrAdmin, imageUpload_1.default.single('image'), twitt_1.default.createTwitt);
